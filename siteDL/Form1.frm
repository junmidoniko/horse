...
Private Sub Command31_Click()
    ...
    ' Folder オブジェクトを取得する
    Dim cFolder As Folder
    Set cFolder = cFso.GetFolder(App.Path & "\yahooRes2\")
...
Private Sub Command34_Click()
    ...
    ' Folder オブジェクトを取得する
    Dim cFolder As Folder
    Set cFolder = cFso.GetFolder(App.Path & "\yahooAll\")
'    Set cFolder = cFso.GetFolder(App.Path & "\")
